...
<section class="booking">
   ...
   <form action="book_form.php" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>how many:</span>
            <!-- <input type="number" name="guests" min="1" id="phone"  pattern="^([0-9]{3}|[0-9]{2}|[0-9]{1})$"> -->
            <input type="number"  name="guests" min='1' onchange="totalprice(this.value)">
         </div>
         <div class="inputBox">
            <span>Package:</span>
            <input type="text"  readonly value="Basic" name="package">
         </div>
         <div class="inputBox">
            <span>Price(Rs):</span>
            <!-- <input type="text" readonly value="Nrs. 10,499"name="price"> -->
      ...
      <input type="submit" value="book" class="btn" name="send" action="index.html">
