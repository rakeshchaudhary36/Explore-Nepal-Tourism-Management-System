   ...
   <form action="book_form.php" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox"></span>
           <span>where to :
         <input type="text" readonly value="Chitwan-Lumbini-Pokhara" name="location">
         ...
         <div class="inputBox">
            <span>Package:</span>
            <input type="text" readonly value="Standard" name="package">
         </div>
         <div class="inputBox">
            <span>Price(Rs):</span>
            <!-- <input type="text" readonly value="Nrs. 10,000"name="price"> -->
